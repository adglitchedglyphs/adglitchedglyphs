...
const GLYPH_NAMES = {
  ...
  tmtrainer: {
    adjective: { high: "Deleted", mid: "Broken", low: "Glitchy" },
    noun: "Glitch"
  },
  reality: {
    adjective: "Real",
...
export default {
  ...
  data() {
    return {
      ...
      glyphTypeList: [
        ...
        { type: "tmtrainer", perc: 0, adjOrder: 7 }
      ],
      sortedGlyphs: [],
      slotCount: 0
    };
  ...
  computed: {
    ...
    singletonName() {
      ...
      const singleGlyphTypes = ["reality", "companion", "tmtrainer"];
    ...
    mainGlyphName() {
      ...
      if (this.calculateGlyphPercent("tmtrainer")) return CosmeticGlyphTypes.tmtrainer;
    ...
    textStyle() {
      ...
      return {
        ...
        animation: this.mainGlyphName.id === "reality" ? "a-reality-glyph-description-cycle 10s infinite" :
          (this.mainGlyphName.id === "tmtrainer" ? "a-tmtrainer-glyph-name-cycle" : undefined),
      };
    }
  },
  created() {
