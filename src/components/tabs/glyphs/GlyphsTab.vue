...
import TMTRAINERMachine from "./TMTRAINERMachine";
...
export default {
  ...
  methods: {
    update() {
      ...
      this.tmtrainerDisplayed = player.reality.showTmtrainerMachine;
    ...
    setInfoState(state) {
      player.reality.showTmtrainerMachine = false;
      player.reality.showGlyphSacrifice = state;
    },
    setMachineState(state) {
      if(state) player.reality.showGlyphSacrifice = false;
      player.reality.showTmtrainerMachine = state;
    },
    glyphColorPosition() {
      ...
      <div class="l-player-glyphs-column">
        ...
        <div class="l-equipped-glyphs-and-effects-container">
          ...
          <div class="l-glyph-info-wrapper">
            ...
            >
              <button
                :class="glyphInfoClass((!sacrificeDisplayed && !tmtrainerDisplayed))"
                @click="setInfoState(false)"
              >
                Current
              </button>
              <button
                :class="glyphInfoClass(tmtrainerDisplayed)"
                @click="setMachineState(true)"
              >
                TMTRAINER
              </button>
              <button
            ...
            <TMTRAINERMachine v-if="tmtrainerDisplayed" />
            <CurrentGlyphEffects
              v-if="!sacrificeDisplayed && !tmtrainerDisplayed"
