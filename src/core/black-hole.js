...
class BlackHoleState {
   ...
   */
  get power() {
    return Math.pow(this.powerUpgrade.value * Achievement(158).effectOrDefault(1), TMTE(107));
  }
  ...
  get displayState() {
    if ((TMTE(108) == 7 && Pelle.isDisabled("blackhole")) || TMTE(108) == 2) return `<i class="fas fa-ban"></i> Disabled`;
    if ((TMTE(108) == 7 && Enslaved.isAutoReleasing) || TMTE(108) < 2) {
      if ((TMTE(108) == 7 && Enslaved.autoReleaseTick < 3)
       || TMTE(108) == 1) return `<i class="fas fa-compress-arrows-alt u-fa-padding"></i> Pulsing`;
      return `<i class="fas fa-expand-arrows-alt u-fa-padding"></i> Pulsing`;
    }
    if ((TMTE(108) == 7 && Enslaved.isStoringGameTime) || TMTE(108) == 3) return `<i class="fas fa-compress-arrows-alt"></i> Charging`;
    if ((TMTE(108) == 7 && BlackHoles.areNegative) || TMTE(108) == 4) return `<i class="fas fa-caret-left"></i> Inverted`;
    if ((TMTE(108) == 7 && BlackHoles.arePaused) || TMTE(108) == 5) return `<i class="fas fa-pause"></i> Paused`;
    if ((TMTE(108) == 7 && this.isPermanent) || TMTE(108) == 6) return `<i class="fas fa-infinity"></i> Permanent`;
