...
export const AutomatorScroller = {
  ...
  scrollToLine(line) {
    ...
    if (player.reality.automator.type === AUTOMATOR_TYPE.TEXT) {
      ...
      textHeight = 34.5; //TMTE here? What does this do??
      lineToScroll = line;
    }
    ...
    const paddedHeight = editor.clientHeight - 40; //TMTE here? What does this do????
...
export const AutomatorBackend = {
  ...
  */
  ...
  get currentInterval() {
    return Math.clampMin(Math.pow(TMTE(15), Currency.realities.value) * 500, 1);
  },
