...
export const singularityMilestones = {
  ...
  autoCondense: {
    ...
    effect: completions => [Infinity, 1.3, 1.22, 1.15, 1.1, 1.06, 1.03, 1.01, 1][Math.round(Math.clamp(completions, 0, 8))],
  ...
  darkDimensionAutobuyers: {
    ...
    effect: completions => Math.round(Math.clamp(completions, 0, 4)),
  ...
  darkAutobuyerSpeed: {
    ...
    effect: completions => [30, 20, 15, 10, 5, 3, 2, 1, 0][Math.round(Math.clamp(completions, 0, 8))],
  ...
  improvedSingularityCap: {
    ...
    effect: completions => TMTE(24) + completions,
