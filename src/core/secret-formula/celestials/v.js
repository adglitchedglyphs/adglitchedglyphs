...
export const v = {
  ...
  mainUnlock: {
    realities: {
      ...
      progress: () => Currency.realities.value*TMTE(155) / 10000,
    },
    eternities: {
      id: 2,
      name: "Eternities",
      ...
      requirement: 1e70,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.eternities.value.pLog10()*TMTE(155) / 70),
    },
    infinities: {
      id: 3,
      name: "Infinities",
      ...
      requirement: 1e160,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.infinitiesTotal.value.pLog10()*TMTE(155) / 160),
    },
    dilatedTime: {
      id: 4,
      name: "Dilated Time",
      ...
      requirement: DC.E320,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(player.records.thisReality.maxDT.pLog10()*TMTE(155) / 320),
    },
    replicanti: {
      id: 5,
      name: "Replicanti",
      ...
      format: x => format(x, 2),
      progress: () => emphasizeEnd(player.records.thisReality.maxReplicanti.pLog10()*TMTE(155) / 320000),
    },
    realityMachines: {
      id: 6,
      ...
      requirement: 1e60,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.realityMachines.value.pLog10()*TMTE(155) / 60),
    },
  },
  runUnlocks: [
    {
  ...
  unlocks: {
    ...
    raUnlock: {
      ...
      description: () => `Have ${formatInt(TMTE(50))} V-Achievements`,
      effect: 2,
      requirement: () => V.spaceTheorems >= TMTE(50)
    }
  }
};
