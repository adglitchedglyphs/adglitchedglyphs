...
export const alchemyResources = {
  ...
  "power": {
    ...
    symbol: "Ω",
    isBaseResource: true,
    effect: amount => 1 + amount / (TMTE(52) * 8),
    tier: 1,
    uiOrder: 1,
    unlockedAt: 2,
  ...
  "replication": {
    ...
    symbol: "Ξ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount / (TMTE(52) * 0.04)),
    tier: 1,
    uiOrder: 4,
    unlockedAt: 5,
  ...
  "dilation": {
    ...
    symbol: "Ψ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount / (TMTE(52) * 0.08)),
    tier: 1,
    uiOrder: 5,
    unlockedAt: 6,
  ...
  "cardinality": {
    ...
    effect: amount => 1 + 0.2 / (1 + amount / (TMTE(52) * 0.8)),
    tier: 2,
    uiOrder: 3,
    unlockedAt: 8,
  ...
  "eternity": {
    ...
    symbol: "τ",
    isBaseResource: false,
    effect: amount => 1 + amount / (TMTE(52) * 0.6),
    tier: 2,
    uiOrder: 2,
    unlockedAt: 9,
  ...
  "inflation": {
    ...
    symbol: "λ",
    isBaseResource: false,
    effect: amount => Decimal.pow10((240000 * TMTE(52)) - 3e5 * amount),
    tier: 2,
    uiOrder: 5,
    unlockedAt: 11,
  ...
  "alternation": {
    ...
    symbol: "ω",
    isBaseResource: false,
    effect: amount => amount / (TMTE(52) * 8),
    tier: 2,
    uiOrder: 4,
    unlockedAt: 12,
  ...
  "effarig": {
    ...
    symbol: TMTE(59)?"Ϙ":"ᛝ",
    isBaseResource: true,
    effect: amount => Math.pow(10, amount / (TMTE(52) * 0.1)),
    tier: 1,
    uiOrder: 1.5,
    unlockedAt: 7,
  ...
  "synergism": {
    ...
    isBaseResource: false,
    effect: amount => {
      const rawValue = 0.3 + 1.3 * Math.sqrt(amount / TMTE(52));
  ...
  "momentum": {
    ...
    symbol: "μ",
    isBaseResource: false,
    effect: amount => 1 + amount / (TMTE(52) * 6),
    tier: 3,
    uiOrder: 3,
    unlockedAt: 15,
  ...
  "decoherence": {
    ...
    symbol: "ξ",
    isBaseResource: false,
    effect: amount => 0.15 * Math.sqrt(amount / TMTE(52)),
    tier: 3,
    uiOrder: 4,
    unlockedAt: 14,
  ...
  "exponential": {
    ...
    symbol: "Γ",
    isBaseResource: false,
    effect: amount => 10 * Math.pow(amount / (TMTE(52) * 0.4), 2),
    tier: 4,
    uiOrder: 2,
    unlockedAt: 18,
  ...
  "uncountability": {
    ...
    symbol: "Θ",
    isBaseResource: false,
    effect: amount => 160 * Math.sqrt(amount / TMTE(52)),
    tier: 4,
    uiOrder: 3,
    unlockedAt: 19,
  ...
  "boundless": {
    ...
    symbol: "Π",
    isBaseResource: false,
    effect: amount => amount / (TMTE(52) * 3.2),
    tier: 4,
    uiOrder: 1,
    unlockedAt: 20,
  ...
  "multiversal": {
    ...
    symbol: "Σ",
    isBaseResource: false,
    effect: amount => 32 * Math.pow(amount / TMTE(52), 2),
    tier: 4,
    uiOrder: 5,
    unlockedAt: 16,
  ...
  "unpredictability": {
    ...
    effect: amount => amount / ((TMTE(52) * 0.4285712) + amount),
    tier: 4,
    uiOrder: 4,
    unlockedAt: 21,
