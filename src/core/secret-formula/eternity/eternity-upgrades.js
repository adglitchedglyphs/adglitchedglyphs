...
export const eternityUpgrades = {
  idMultEP: {
    ...
    effect: () => Currency.eternityPoints.value.plus(1).times(TMTE(160)),
  ...
  idMultEternities: {
    ...
    effect() {
      ...
      return multPostCap.times(multPreCap).times(TMTE(160));
    },
    formatEffect: value => formatX(value, 2, 1)
  },
  idMultICRecords: {
    ...
    effect: () => DC.D2.pow(30 / Math.clampMin(Time.infinityChallengeSum.totalSeconds, 0.1)).times(TMTE(160)),
    cap: DC.D2P30D0_61,
    formatEffect: value => formatX(value, 2, 1)
  },
  tdMultAchs: {
    ...
    effect: () => Achievements.power*(TMTE(160)),
    formatEffect: value => formatX(value, 2, 1)
  },
  tdMultTheorems: {
    id: 5,
    ...
    effect: () => Decimal.max(Currency.timeTheorems.value, 1).times(TMTE(160)),
    formatEffect: value => formatX(value, 2, 1)
  },
  tdMultRealTime: {
    id: 6,
    ...
    effect: () => (Pelle.isDoomed ? 1 + Time.thisReality.totalDays*TMTE(160) : Math.max(Time.totalTimePlayed.totalDays*TMTE(160), 1)),
    formatEffect: value => formatX(value, 2, 1)
  }
};
