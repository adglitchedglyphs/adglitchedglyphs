...
export const news = [
  ...
  },
  {
    ...
    text:
      ...
      Polk, Potassium, Pulley, Quinary, Rook, Saturn, TMTRAINER, Tiger, Varaha, Yale, and Yellow.`
  },
  {
    id: "a348",
  ...
  },
  {
    id: "a391",
    text:
      `Local Antimatter Dimensions player from another Universe reports seeing a 'specific Quality 0 item YOU KNOW WHICH ONE'
      in the 'Treasure Room', has been shouting 'I am NOT taking that again!' like a madman for the past 5 hours`
  },
  {
    id: "a392",
    text: "TMTRAINER, TMTRAINER, who's the unluckiest in the Multiverse?"
  },
  {
    id: "a393",
    text:
      `Welcome everyone to the Cursed Randomizer, episode 251. Last time we beat P3 and we're now getting the last
      bosses for P4. For new subscribers: We're on SS, going for 112%, Split Items is enabled,
      Clone Important Items is disabled. Swim is randomized but we found it a hundred episodes ago.
      We also want to beat P5 so we're gonna real quick get all directions for Split Nai-
      Wait, what do you mean wrong mod?`
  },
  {
    id: "a394",
    get text() {
      const tmtrainerNews = window.RANDOM_TMTRAINER_NEWS();
      return `We have recently received complaints that the 'mod developer' should not include 'custom news messages'
        in their 'mod' because they're unfunny. We at A.N.N. have no idea what that means.
        Therefore, we will let the 'mod' create its own news message:                          ${tmtrainerNews}`
    }
  },
  {
    id: "l1",
