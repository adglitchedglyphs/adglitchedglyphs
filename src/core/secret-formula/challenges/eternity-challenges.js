...
export const eternityChallenges = [
  {
    ...
    reward: {
      ...
      effect: completions =>
        Decimal.pow(Math.max(player.records.thisEternity.time / 10, 0.9), 0.3 + (completions * TMTE(157) * 0.05)),
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => Currency.infinityPower.value.pow(1.5 / (700 - completions * TMTE(157) * 100)).clampMin(1),
      cap: DC.E100,
      formatEffect: value => formatX(value, 2, 1)
    }
  },
  {
    ...
    reward: {
      ...
      effect: completions => completions * 0.72 * TMTE(157),
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => Currency.infinityPoints.value.pow(0.003 + completions * 0.002 * TMTE(157)),
      cap: DC.E200,
      formatEffect: value => formatX(value, 2, 1)
    }
  },
  {
    ...
    reward: {
      ...
      effect: completions => completions * 5 * TMTE(157),
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => completions * 0.2 * TMTE(157),
      formatEffect: value => {
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => TimeDimension(1).productionPerSecond.pow(completions * 0.2 * TMTE(157)).minus(1).clampMin(0),
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => {
        ...
        return Math.max(0, Math.pow(infinityPower, 0.03 * completions * TMTE(157)) - 1);
      },
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => Currency.timeShards.value.pow(completions * 0.1 * TMTE(157)).clampMin(1),
      cap: DC.E400,
      formatEffect: value => formatX(value, 2, 1)
    }
  },
  {
    ...
    reward: {
      ...
      effect: completions => {
        const mult = Currency.infinitiesTotal.value.times(2.783e-6).pow(0.4 + 0.1 * completions * TMTE(157)).clampMin(1);
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => completions * 0.07 * TMTE(157),
      formatEffect: value => {
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => 1 - completions * 0.008 * TMTE(157),
