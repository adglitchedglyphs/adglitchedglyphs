...
const INTERVAL_COST_MULT = TMTE(17);
const POWER_DM_COST_MULT = TMTE(18);
const POWER_DE_COST_MULTS = [TMTE(19)+TMTE(20)*TMTE(21)*3, TMTE(19)+TMTE(20)*TMTE(21)*2, TMTE(19)+TMTE(20)*TMTE(21), TMTE(19)];
...
export class DarkMatterDimensionState extends DimensionState {
  ...
  get powerDM() {
    ...
    return new Decimal(1 + 2 * Math.pow(1.15, this.data.powerDMUpgrades)) //TMTE? What is this???
