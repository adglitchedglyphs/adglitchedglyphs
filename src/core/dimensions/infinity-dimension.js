...
class InfinityDimensionState extends DimensionState {
  ...
  get purchases() {
    ...
    return this.data.baseAmount / TMTE(76);
  }
  ...
  get purchaseCap() {
    ...
    let hardcap = InfinityDimensions.HARDCAP_PURCHASES;
    return InfinityDimensions.capIncrease + ((this.tier === 8)
      ? (TMTE(77) ? hardcap : maxval)
      : (TMTE(77) ? maxval : hardcap));
  }
